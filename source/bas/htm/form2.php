...
*/
class bas_htm_form2 extends bas_htm_page{
	private $menu;
	
	public function __construct($title, $menu, $toolbar=array(), $formtype='form2', $loadformpars=''){
		
		
		parent::__construct($title, $formtype, $formtype);
		$this->addevent('onload', "loadform($loadformpars)");
		$this->menu = $menu; 			
		...
		//$this->opendiv('content'); El contenido es responsabilidad del pintor.
		
		#level 2 - Pie
		$this->setlevel(2);
		//$this->closediv(); #content
		$this->opendiv('statusbar'); $this->p(''); $this->closediv();
		$this->closeform();
